...
const Hero = () => {
  ...
  return (
    <motion.div
      ...
      className='relative h-screen flex flex-col items-center justify-center gap-14 text-center bg-cover bg-center bg-no-repeat'
      style={{ backgroundImage: `url(${assets.banner_car_image})` }}
    >
      <div className='absolute inset-0 bg-black/40' />

      <div className='relative z-10 flex flex-col items-center justify-center gap-14 w-full px-4'>
        <motion.h1
